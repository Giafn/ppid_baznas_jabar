    ...
    <div class="card-body">
        <div class="row g-2">
            <div class="col-12 mb-2">
                <a class="btn bg-green-primary" href="/admin/informasi-publik/setiap-saat/create">
                    Tambah item
                </a>
                <form action="/admin/informasi-publik/setiap-saat" method="GET">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/informasi-publik/setiap-saat/{{ $item->id }}/edit" class="btn bg-green-primary">
                                        Edit
                                    </a>
...
<script>
    function openModalDelete(id) {
        ...
        $('#modalDeleteForm').attr('action', '/admin/informasi-publik/setiap-saat/' + id);
    }
</script>
@endpush
