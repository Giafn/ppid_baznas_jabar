    ...
    <div class="card-body">
        <div class="row g-2">
            <div class="col-12 mb-2">
                ...
                <form action="/admin/layanan-informasi/list" method="GET">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/layanan-informasi/list/{{ $item->id }}/edit" class="btn bg-green-primary">
                                        Edit
                                    </a>
