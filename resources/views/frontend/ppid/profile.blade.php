    ...
    <div class="row justify-content-center my-5 px-2">
        <div class="col-md-10">
            <h3 class="text-center fw-bolder mb-3 text-green-primary">
                Profile PPID BAZNAS Jawa Barat
            </h3>
            ...
            <ol>
                <li>perencanaan pengumpulan, pendistribusian dan pendayagunaan zakat;</li>
                <li>pelaksanaan pengumpulan, pendistribusian dan pendayagunaan zakat;</li>
                <li>pengendalian pengumpulan, pendistribusian dan pendayagunaan zakat;</li>
                <li>pelaporan dan pertanggungjawaban pelaksanaan pengelolaan zakat.</li>
            </ol>
            <p>
